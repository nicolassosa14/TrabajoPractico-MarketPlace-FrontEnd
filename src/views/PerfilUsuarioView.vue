  ...
  <div class="container mt-4">
    ...
    <div v-else-if="data" class="card">
      <div class="card-body text-center">
        <div class="mb-4">
          <img :src="imageError ? defaultImageUrl : (data.image_url || defaultImageUrl)" :alt="data.first_name"
            class="rounded-circle profile-image mb-3" @error="handleImageError">
        </div>
            ...
            <div class="modal-dialog modal-dialog-centered">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <div class="form-group">
                    ...
                    <input type="tel" class="form-control" id="phoneNumber" v-model="phoneNumber"
                      placeholder="Ingresa tu número de teléfono" :disabled="isUpdating">
                  </div>
                </div>
                <div class="modal-footer">
                  ...
                  <button type="button" class="btn btn-danger" @click="updatePhoneNumber"
        ...
        <div v-if="canCreateLocal" class="mt-4 mb-4">
          <div class="alert alert-info d-flex align-items-center justify-content-between">
            <div>
              ...
              <strong>¿Tienes un local?</strong> Crea tu local para comenzar a vender.
            </div>
            <RouterLink to="/locales/crear" class="btn btn-danger">
        ...
        <SeccionDirecciones v-if="data.addresses && data.user_id" :addresses="data.addresses" :user-id="data.user_id"
