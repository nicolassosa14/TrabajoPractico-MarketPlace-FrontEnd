...
const badges = ref([
  { text: 'Entrega rápida', icon: IconFastDelivery },
  { text: 'Pago seguro', icon: IconSafePayment },
      ...
      <div class="row align-items-center g-5">
        <div class="col-md-6">
          ...
          <div class="d-flex flex-wrap gap-3 mb-4">
            ...
            <div class="d-flex align-items-center border rounded p-2">
              <i class="bi bi-file-lock2-fill me-1"></i> 
              <span>
                Compras Seguras
              </span>
            </div>
        ...
        <div class="col-md-6">
          <div class="ratio ratio-1x1 rounded-3 shadow-lg overflow-hidden">
            <img
              :src="heroImage"
              alt="Repartidor de MandaditosApp en bicicleta con bolsas de compras"
              class="img-fluid"
